...
const Navbar = () => {
  ...
  const recommendFilmButton = user ? (
    <Link to="/recommend" className="flex items-center">
      ...
      <div className="flex items-center gap-2">
        {user && (
          <div className="nav-menu ">
            ...
            <Tooltip label="Give Feedback" aria-label="a tooltip">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
        ...
        {!isLoginPage && !isSignupPage && !user && (
          <Link to="/auth/login" className="font-outfit ">
        ...
        {user && (
          <>
            <span className="font-outfit">{user.username}</span>{" "}
            <Tooltip label="Account" aria-label="a tooltip">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
